...
<body>
    <div class="container">
        ...
        <nav class="top-navbar">
            ...
            <div class="nav-links">
                ...
                <% if ("MANAGER".equals(session.getAttribute("role")) || "EMPLOYEE".equals(session.getAttribute("role"))) { %>
                    <a href="customer.jsp" class="nav-button active">Customer Management</a>
                <% } %>
        ...
        <div class="operation-buttons">
            <button id="view-customers-btn" class="operation-btn">View Customers</button>
            <% if ("MANAGER".equals(session.getAttribute("role")) || "EMPLOYEE".equals(session.getAttribute("role"))) { %>
                <button id="update-customer-btn" class="operation-btn">Update Customer</button>
            <% } %>
            <% if ("MANAGER".equals(session.getAttribute("role"))) { %>
                <button id="delete-customer-btn" class="operation-btn">Delete Customer</button>
            <% } %>
        </div>
        ...
        <div id="view-customers" class="content-section">
            ...
            <div class="view-tabs">
                <button id="single-tab-btn" class="tab-btn active">Single Customer</button>
                <button id="email-tab-btn" class="tab-btn">By Email</button>
                <% if ("MANAGER".equals(session.getAttribute("role")) || "EMPLOYEE".equals(session.getAttribute("role"))) { %>
            ...
            <div id="single" class="tab-content active">
                ...
                <form id="viewCustomerForm" action="customer" method="get" class="form-container">
            ...
            <div id="email" class="tab-content">
                <h4>View Customer by Email</h4>
                <form id="viewCustomerByEmailForm" action="customer" method="get" class="form-container">
                    ...
                    <button type="submit" class="submit-btn">View Customer by Email</button>
                </form>
            </div>
            ...
            <div id="branch" class="tab-content">
                ...
                <form id="viewCustomersByBranchForm" action="customer" method="get" class="form-container">
                    ...
                    <button type="submit" class="submit-btn">View Branch Customers</button>
                </form>
            </div>
            <% } %>
        </div>
        ...
        <div id="update-customer" class="content-section">
            ...
            <form id="updateCustomerForm" action="customer" method="post" class="form-container">
        ...
        <div id="delete-customer" class="content-section">
            ...
            <div class="warning-message">
                <p>⚠️ Warning: This action cannot be undone. Customer must not have any active accounts.</p>
            </div>
            <form id="deleteCustomerForm" action="customer" method="post" class="form-container">
                ...
                <button type="submit" class="submit-btn danger">Delete Customer</button>
            </form>
        </div>
        <% } %>
